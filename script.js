...
document.getElementById("raccoonBtn").addEventListener("click", () => { gooseCount += 3; inflateMetrics(1); setChaosContent(warningText, "Raccoons released successfully. Nobody is in charge anymore."); applyChaosStage(); releaseRaccoons(14); });
document.getElementById("bureaucratBtn").addEventListener("click", () => { setChaosContent(warningText, "Coin accepted. Bureaucrat fed. Chips are now moving through the system."); applyChaosStage(); feedTheBureaucrat(); });
